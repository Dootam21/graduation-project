...
const NhapSoLuongMa = ({ navigation }) => {
        ...
        <SafeAreaView style={{ flex: 1 }}>
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.title}>Nhập số lượng mã</Text>
                    <View style={styles.headerRight}>
                        <TouchableOpacity>
                            <Text style={styles.btnTextHeader}>Xong</Text>
                        </TouchableOpacity>
                    </View>
                </View >
                ...
                <Text style={styles.txtTotal}>Tổng số lượng: 0</Text>
