...
function SelectAvatar({ ismodal, setIsModal, setImage }) {

    const [images, setImages] = useState([]);
    const [image_show, setImage_show] = useState([]);

    const removeImage = (stt) => {
        var buff = [];
        var num = 0;
    ...
    const upload_images = (images2upload) => {
    ...
    return (
        <Modal
            ...
            <View style={styles.centeredView}>
                <View style={styles.modalView}>
                    ...
                    <TouchableOpacity onPress={() => select_camera()}>
                        <Text style={[styles.txtFilter, styles.activeCL]}>Chụp ảnh</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={() => select_image()}>
                        <Text style={[styles.txtFilter, styles.activeCL]}>Thư viện ảnh</Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <TouchableOpacity activeOpacity={1} onPress={() => setIsModal(false)}
