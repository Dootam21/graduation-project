...
import { UPDATE_LIST_ALL_COLOR, RESET_COLOR, LIST_COLOR_OBJECT } from '../constants/actionTam'
...
const colorAction = (act, data) => async (dispatch) => {
    switch (act) {
        ...
        case 'reset_color':
            dispatch({ type: RESET_COLOR }); break;

        case 'list_color_object':
            dispatch({ type: LIST_COLOR_OBJECT, payload: data }); break;
