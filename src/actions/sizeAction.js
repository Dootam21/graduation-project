...
import { UPDATE_LIST_ALL_SIZE, RESET_SIZE, LIST_SIZE_OBJECT } from '../constants/actionTam';
...
const sizeAction = (act, data) => async (dispatch) => {
    switch (act) {
        ...
        case 'reset_size':
            dispatch({ type: RESET_SIZE }); break;

        case 'list_size_object':
            dispatch({ type: LIST_SIZE_OBJECT, payload: data }); break
        default:
            break;
    }
}
