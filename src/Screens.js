...
import ListRole from './containers/profile/danh-sach-vai-tro.js';
import DetailRole from './containers/profile/chi-tiet-vai-tro.js';
...
import NhapTraOrderConfirm from './containers/cart/nhap-tra-order-confirm.js';
...
import ChiTietPhieuTraXuong from './containers/returning-goods/chi-tiet-phieu-tra-xuong.js';
import ChiTietPhieuKhachTra from './containers/returning-goods/chi-tiet-phieu-khach-tra.js';
...
import ConnectPrinter from './containers/cart/connect-printer.js';
import ImagePrinter from './containers/cart/imagePrinter.js';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen name="ListRole" component={ListRole} options={{ headerShown: false, drawerLabel: "Danh sách vai trò" }} />
        <Stack.Screen name="DetailRole" component={DetailRole} options={{ headerShown: false, drawerLabel: "Chi tiết vai trò" }} />
        ...
        <Stack.Screen name="NhapTraOrderConfirm" component={NhapTraOrderConfirm} options={{ headerShown: false, drawerLabel: "Xác nhận toa nhập" }} />
        ...
        <Stack.Screen name="CreateFormFactory" component={CreateFormFactory} options={{ headerShown: false, drawerLabel: "Tạo phiếu trả xưởng" }} />
        <Stack.Screen name="ChiTietPhieuTraXuong" component={ChiTietPhieuTraXuong} options={{ headerShown: false, drawerLabel: "Chi tiết phiếu trả xưởng" }} />
        <Stack.Screen name="DSPhieuNhap" component={DSPhieuNhap} options={{ headerShown: false, drawerLabel: "Danh sách phiếu nhập" }} />
        <Stack.Screen name="ChiTietPhieuKhachTra" component={ChiTietPhieuKhachTra} options={{ headerShown: false, drawerLabel: "Chi tiết phiếu khách trả" }} />
        ...
        <Stack.Screen name="ConnectPrinter" component={ConnectPrinter} options={{ headerShown: false, drawerLabel: "Kết nối máy in" }} />
        <Stack.Screen name="ImagePrinter" component={ImagePrinter} options={{ headerShown: false, drawerLabel: "Xử lý in" }} />
